...
module "metrics_server" {
  source                = "../module/applications/app"   
...
module "argocd" {
  ...
  values_file                    = "../module/applications/app/values/argocd.yaml"
  eks_dependency                 =  module.eks.eks_node_group_dependency
...
module "prometheus" {
  source                        = "../module/applications/promethous-and-grafana"
  namespace                     = "prometheus"
  chart_version                 = "45.10.0"
  values_file                   = "../module/applications/promethous-and-grafana/values/promethousvalues.yaml"
  eks_dependency                = module.eks.eks_node_group_dependency
}
